...
////        [HttpPost("generate")]
////        public async Task<IActionResult> GenerateLesson([FromBody] LessonRequestDto request)
////        {
////            var result = await _lessonService.GenerateLessonAsync(request);
////            return Ok(result);
////        }
////    }
////        //private readonly LessonService _lessonService;
...
//namespace AI.LearningPlatform.API.Controllers
//{
//    [ApiController]
//    [Route("api/[controller]")]
...
//        [HttpPost("generate")]
//        public async Task<ActionResult<Lesson>> GenerateLesson([FromBody] LessonRequestDto request)
//        {
//            var lesson = await _lessonService.GenerateLessonAsync(request);
//            return Ok(lesson);
//        }
//    }
//}
